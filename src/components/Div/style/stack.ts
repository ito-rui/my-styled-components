...
import type { HStackType, VStackType } from "../../../types/components/Div";
import { getMarginRight, getMarginBottom } from "../../../utils/getStyle";

export const StyledHStack = styled(StyledFlex)<HStackType>`
	flex-direction: row;
	& > *:not(:last-child) {
...
export const StyledVStack = styled(StyledFlex)<VStackType>`
